/**
 * Background Switcher View Component
 *
 * Note: This component still uses the legacy DesktopContext for background changes.
 * In a full migration, this would use EventBus or a service instead.
 */

import React, { useState } from 'react'
import styles from '../../components/apps/BackgroundSwitcher.module.scss'
import { backgroundAssets } from '../../assets/background/backgroundAssets'
import { useDesktop } from '../../contexts/DesktopContext'

export const BackgroundSwitcherView: React.FC = () => {
