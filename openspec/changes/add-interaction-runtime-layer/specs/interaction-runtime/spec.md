...
### Requirement: IR-001 TitleBar Interaction Engine
...
#### Scenario: IR-001.1 Only left drag zone starts window drag
...
#### Scenario: IR-001.2 TitleBar engine reused across windows
...
### Requirement: IR-002 Button State Machine Runtime
...
#### Scenario: IR-002.1 Pressed state overrides hover
...
#### Scenario: IR-002.2 Toggle buttons maintain active state
...
#### Scenario: IR-002.3 Focus ring and keyboard activation
- **GIVEN** a button using the Button State Machine
...
### Requirement: IR-003 Window Focus Manager with Inactive Dimming
...
#### Scenario: IR-003.1 Single active window with managed z-index
...
#### Scenario: IR-003.2 Inactive windows dim but remain interactive
...
### Requirement: IR-004 Menu Mode Engine (OS9 Menu Behavior)
...
#### Scenario: IR-004.1 Click to enter and exit menu mode
...
#### Scenario: IR-004.2 Hover switches menus only in menu mode
...
#### Scenario: IR-004.3 Keyboard navigation in menu mode
...
### Requirement: IR-005 Finder Selection Engine and Keyboard Navigation
...
#### Scenario: IR-005.1 Single and multi-selection behavior
...
#### Scenario: IR-005.2 Keyboard navigation in grid and list
...
#### Scenario: IR-005.3 Selection visuals match blueprint (no bevel)
